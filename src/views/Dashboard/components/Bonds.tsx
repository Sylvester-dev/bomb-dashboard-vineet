          ...
          <Paper style={{ background: 'rgba(32, 37, 67, 0.5)', borderRadius: '5px' }}>
            ...
            <Grid container spacing={3} style={{ textAlign: 'center' }}>
              <Grid item xs={3} style={{ padding: '0' }}>
                ...
                <h3 style={{ color: 'white', marginTop: '10px' }}>BBond = {Number(bondStat?.tokenInFtm).toFixed(4) || '-'} BTCB</h3>
              </Grid>
              ...
              onPresentP();
              ...
              }} disabled={!bondStat || isBondRedeemable} style={{ border: 'solid 2px', borderRadius: '20px', marginRight: '10px' }}>
                  ...
                  <p style={{ color: 'white' }}>
                    ...
                    <span style={{ float: 'right' }}>
                      <Button onClick={()=>{
              onPresentR();
            }} disabled={!bondStat || bondBalance.eq(0) || !isBondRedeemable} style={{ border: 'solid 2px', borderRadius: '20px', marginRight: '10px' }}>
